 ...
 */
let bill = parseFloat(prompt("What is your bill total?"));
let tipPercent = parseFloat(prompt("What percentage would you like to tip?)"));
let tipAmount = (bill*tipPercent*0.01);
alert("The tip amount will be $" + tipAmount +" ." );
console.log("The tip amount will be $" + tipAmount +" ." );
/**
 * TODO:
